...
## pytraceview Software License (Apache 2.0 with Attribution Addendum)
...
1. **Attribution Required**  
   ...
   clear attribution to the original author(s) and the ChipFX pytraceview project.
   Attribution must appear in:
   - the documentation and/or other materials provided with the distribution, AND
   - any "About" screen, credits section, or equivalent user-visible notice
     in derived software.

2. **Branding Retention (Requested, Not Mandatory)**  
   We kindly request — but do not legally require, for complicated lawyery reasons —
   that the ChipFX pytraceview name and any associated attribution notice be retained
   in the user interface of distributed versions.
...
3. **Notice File**  
   ...
   `NOTICE.md` file unmodified.

4. **No Trademark Grant**  
   This license does not grant permission to use the "ChipFX" or "pytraceview"
   trade names, trademarks, or service marks in a way that implies endorsement
   of derived products by ChipFX, except as required for attribution.
...
*This license was last updated: 2026-05-02*  
